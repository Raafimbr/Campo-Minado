...
def imagensCriar():
    ...
    try:
        ...
        imagemN1 = PhotoImage(file='campo_minado/imagens/N1.png')
    try:
        imagemN2 = PhotoImage(file='imagens/N2.png')
    except:
        imagemN2 = PhotoImage(file='campo_minado/imagens/N2.png')
    try:
        imagemN3 = PhotoImage(file='imagens/N3.png')
    except:
        imagemN3 = PhotoImage(file='campo_minado/imagens/N3.png')
    try:
        imagemN4 = PhotoImage(file='imagens/N4.png')
    except:
        imagemN4 = PhotoImage(file='campo_minado/imagens/N4.png')
    try:
        imagemN5 = PhotoImage(file='imagens/N5.png')
    except:
        imagemN5 = PhotoImage(file='campo_minado/imagens/N5.png')
    try:
        imagemN6 = PhotoImage(file='imagens/N6.png')
    except:
        imagemN6 = PhotoImage(file='campo_minado/imagens/N6.png')
    try:
        imagemN7 = PhotoImage(file='imagens/N7.png')
    except:
        imagemN7 = PhotoImage(file='campo_minado/imagens/N7.png')
    try:
        imagemN8 = PhotoImage(file='imagens/N8.png')
    except:
        imagemN8 = PhotoImage(file='campo_minado/imagens/N8.png')

    try:
        imagemBomba = PhotoImage(file='imagens/bomba.png')
    except:
        imagemBomba = PhotoImage(file='campo_minado/imagens/bomba.png')
    try:
        imagemBombaErrada = PhotoImage(file='imagens/bombaErrada.png')
    except:
        imagemBombaErrada = PhotoImage(file='campo_minado/imagens/bombaErrada.png')
    try:
        imagemBombaPerda = PhotoImage(file='imagens/bombaPerda.png')
    except:
        imagemBombaPerda = PhotoImage(file='campo_minado/imagens/bombaPerda.png')
    try:
        imagemBotaoNada = PhotoImage(file='imagens/botaoNada.png')
    except:
        imagemBotaoNada = PhotoImage(file='campo_minado/imagens/botaoNada.png')
    try:
        imagemBandeira = PhotoImage(file='imagens/bandeira.png')
    except:
        imagemBandeira = PhotoImage(file='campo_minado/imagens/bandeira.png')
